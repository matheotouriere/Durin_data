...
plant_id_data_OF$siteID <- factor(plant_id_data_OF$siteID, levels = c("Kautokeino", "Senja", "Sogndal", "Lygra"))
...
SP_data_picture_OF <-filter(SP_data_picture, habitat %in% c("Open", "Forested"))|> 
   mutate(siteID = ifelse(siteID == "Senje", "Senja", siteID))
SP_data_picture_OF$siteID <- factor(SP_data_picture_OF$siteID, levels = c("Kautokeino", "Senja", "Sogndal", "Lygra"))

...
loop.files <-  function(files){
  ...
  area <- try(run.ij(path.imagej = "C:/Users/Touriere/Desktop/Utilitaires/ImageJ",
...
run.ij(path.imagej = "C:/Users/Touriere/Desktop/Utilitaires/ImageJ",
       set.directory = "D:/Utilisateurs/Touriere/Documents/SIRD_leaf_area/Calculation/2024_DURIN_leaf_scans_1907_PI_Grogu",
       distance.pixel = 237, known.distance = 2,
       log = TRUE,
       # Pick a minimum size threshold (removes dust spects etc.)
       low.size = 0.005,
...
list.of.files <- dir(path = paste0("D:/Utilisateurs/Touriere/Documents/SIRD_leaf_area/Original/2024_DURIN_Leaf_Scans_1907_PI_Grogu"), pattern = "jpeg|jpg", recursive = TRUE, full.names = TRUE)
...
new.folder <- "D:/Utilisateurs/Touriere/Documents/SIRD_leaf_area/Calculation/2024_DURIN_Leaf_Scans_1907_PI_Grogu/Temp" # "raw_data/Temp/"
output.folder <- "D:/Utilisateurs/Touriere/Documents/SIRD_leaf_area/Calculation/2024_DURIN_Leaf_Scans_1907_PI_Grogu/output/" # raw_data/output
...
dim(LeafArea.raw_total)
write.csv(leaf_area, file = "D:/Utilisateurs/Touriere/Documents/SIRD_leaf_area/Calculation/2024_DURIN_Leaf_Scans_1907_PI_Grogu/output/DURIN_Calculated_Leaf_Area_2024_07_19.csv")

...
# aggregate with your custom function. (how many records are below -10°C per month)
tms.all.custom <- mc_agg(tms, fun = list(TMS_T3 = "below10"), period = "month",
                         custom_functions = list(below10 = function(x){length(x[x<(-10)])}))
...
tms.all.custom <- mc_agg(tms, fun = list(TMS_T3 = "below5"), period = "month",                              min_coverage = 0.8,
